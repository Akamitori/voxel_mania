...
EXPORTED constexpr float DegreeToRadians(float degrees);

EXPORTED constexpr float RadiansToDegrees(float radians);

EXPORTED constexpr float normalize_radians(float radians);
